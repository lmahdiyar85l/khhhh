...
// 建议修改为自己的 UUID
let userID = '6fd1634e-9f6e-43b6-9ff0-096df4b85119';

// 生成配置文件的 CF 优选 IP
const bestCFIP = "arvancloud.ir"

// 用于 CF 网站的代理 IP
const proxyIPs = ["146.70.169.118u"]; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
